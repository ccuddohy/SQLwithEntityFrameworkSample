...
/// <summary>
/// this is from a Microsoft getting started tutorial. I did the first part of the tutorial in project SqlSample. This
/// part is using EntityFramework. https://www.microsoft.com/en-us/sql-server/developer-get-started/csharp/win/step/2.htmlml
/// </summary>

namespace SQLwithEntityFrameworkSample
{
	class Program
	{
		static void Main(string[] args)
		{
            ...
            try
            {
                ...
                builder.UserID = "Dude";              // update me
                builder.Password = "KaylaB2";      // update me
